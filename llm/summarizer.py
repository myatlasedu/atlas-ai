...
def build_prompt(
    ...
    context, say so briefly in your own friendly words. Do NOT
    use boilerplate such as "based on the supplied context",
    "insufficient data", or "the available information does not
